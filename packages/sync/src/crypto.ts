 ...
 * - **La clave se deriva no extraíble**: el navegador la persiste sin exponer
 *   nunca sus bytes. *Dónde* se guarda es cosa de cada app (cada una tiene su
 *   propia base local), así que este módulo no persiste nada.
 *
